...
import { TenantController } from '../../controllers/fixes/tenant.controller';
...
import { inviteUserToTenant, removeUserAccessToTenant, createNewTenantValidator, findAllTenantValidator } from '../../validators/fixes/tenant.validator';
