...
export default class MenuItemRepository extends BaseRepository<IMenuItemDatabaseModel, MenuItem>{ 
  ...
  constructor(tenantConnection: TenantConnection){ 
    const _adapter : IDatabaseAdapter<IMenuItemDatabaseModel, MenuItem> = createDbAdapter<IMenuItemDatabaseModel, MenuItem>(tenantConnection.models!.get("nfMenuItem"), tenantConnection.databaseType, tenantConnection.connection, MenuItem.fromJson);
